...
OrderItem.create!([
  {product_id: 7, order_id: 1, unit_price: -5.0, quantity: 1},
  {product_id: 1, order_id: 1, unit_price: 5.0, quantity: 4},
  {product_id: 5, order_id: 1, unit_price: 30.0, quantity: 1},
  {product_id: 6, order_id: 1, unit_price: 25.0, quantity: 2},
  {product_id: 4, order_id: 2, unit_price: 15.0, quantity: 1},
  {product_id: 5, order_id: 3, unit_price: 30.0, quantity: 1},
  {product_id: 6, order_id: 4, unit_price: 25.0, quantity: 1},
  {product_id: 5, order_id: 5, unit_price: 30.0, quantity: 1}
])
Product.create!([
...
Review.create!([
  {user_id: nil, product_id: 5, rate: 4, status: "approved", reviewer_name: "Svatok", review_text: "Very good book!"},
  {user_id: 3, product_id: 5, rate: 5, status: "approved", reviewer_name: "11111111111S last", review_text: "Super book!"},
  {user_id: 3, product_id: 5, rate: 3, status: "approved", reviewer_name: "Svat last", review_text: "Not impressed :("}
])
Address.create!([
...
Price.create!([
  ...
  {value: 15.0, date_start: "2017-02-15", priceable_type: "Product", priceable_id: 4},
  {value: 5.0, date_start: "2017-02-13", priceable_type: "Product", priceable_id: 1},
  {value: 25.0, date_start: "2017-02-17", priceable_type: "Product", priceable_id: 6},
  {value: -5.0, date_start: "2017-02-20", priceable_type: "Product", priceable_id: 7}
])
Property.create!([
  {name: "Height"},
  {name: "Width"},
...
Stock.create!([
  ...
  {product_id: 6, value: 12, date_start: "2017-02-17"},
